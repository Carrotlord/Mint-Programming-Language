 ...
 * @author Oliver Chu
 */
public class Mul extends BuiltinSub {
    ...
    public Pointer apply(SmartList<Pointer> args) throws MintException {
        ...
        if (arg0.type == Constants.BIG_INT_TYPE &&
            ...
            return Heap.allocateBigInt(bi0.multiply(bi1));
            ...
            return Heap.allocatePreciseReal(bd0.multiply(bd1));
        }
        if (arg0.type == Constants.INT_TYPE && arg1.type == Constants.INT_TYPE)
        {
            ...
            if (arg0 == null || arg1 == null) {
                throw new MintException("Multiplication can only be " + 
                                        "applied to integers or reals.");
            }
